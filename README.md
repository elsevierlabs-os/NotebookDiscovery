...
Notebook Discovery is provided as a [download](https://github.com/elsevierlabs-os/NotebookDiscovery/download/NotebookDiscovery-1.0.0.dbc).  This is a DBC (Databricks archive) file.
